#---------------------------------------------------------------------------
# Functions related to calcium measurements
#---------------------------------------------------------------------------
# Packages needed for analysis of calcium data
#----------------------------------------------------------------------
...
def calc_comp(df):
    ...
    c=df.c0_mean
    try:
        d_max=pd.read_csv(cfg.df_paths.path[1]).to_dict('records')[0]#'Calcium comp\\df_reg zz max_calc.csv'
        d_min=pd.read_csv(cfg.df_paths.path[2]).to_dict('records')[0]#'Calcium comp\\df_reg zz min_calc.csv'
